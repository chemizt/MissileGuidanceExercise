...
class Missile : public MovingObject // класс ракет
{
	...
	private:
		...
		double _calculateLiftInducedDragCoefficient(double angleOfAttack) { return angleOfAttack * MissileParameters::DyPerDa; };		// вычисляет коэфф. индуктивного сопротивления по углу атаки
